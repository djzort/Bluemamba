...
/*********************************************************************
    ...
    Document: include/mime.php
              
    Function: Provide functions for handling mime messages
...
function iml_GetPartList($a, $part)
{
	...
	if($num_parts !== false)
	{
		...
		for ($i = 0; $i<$num_parts; $i++)
		{
			...
			if(strcasecmp($part_disposition, "attachment")!=0 && (($part_type == 1) || ($part_type==2)))
			{
